import { i as head, d as ensure_array_like, f as attr, e as escape_html, b as attr_class, h as stringify } from "../../../chunks/renderer.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="mb-8"><h1 class="admin-page-title text-2xl">Dashboard</h1> <p class="admin-page-sub mt-1">Übersicht über alle Inhalte</p></div> <div class="grid grid-cols-1 sm:grid-cols-3 gap-4"><!--[-->`);
